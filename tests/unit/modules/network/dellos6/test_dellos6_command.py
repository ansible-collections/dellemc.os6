...
from ansible_collections.dellemc_networking.os6.plugins.modules import dellos6_command
...
class TestDellos6CommandModule(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.dellemc_networking.os6.plugins.modules.dellos6_command.run_commands')
