...
from ansible_collections.dellemc_networking.os6.tests.unit.compat.mock import patch
from ansible_collections.dellemc_networking.os6.plugins.modules import dellos6_config
from ansible_collections.dellemc_networking.os6.tests.unit.modules.utils import set_module_args
...
class TestDellos6ConfigModule(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.dellemc_networking.os6.plugins.modules.dellos6_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.dellemc_networking.os6.plugins.modules.dellos6_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.dellemc_networking.os6.plugins.modules.dellos6_config.run_commands')
